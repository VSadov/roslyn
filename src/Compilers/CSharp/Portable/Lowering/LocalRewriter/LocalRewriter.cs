...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal sealed partial class LocalRewriter : BoundTreeRewriterWithStackGuard
    {
        ...
        //        }
        //
        internal static bool ReceiverCouldBePassedByReference(BoundExpression receiver)
        {
            ...
            //     with one exception being spilling of the value into a local, which is ok.

            return CanBePassedByReference(receiver);
        }
        ...
        //        }
        //
        private static bool CanBePassedByReference(BoundExpression expr)
        {
            ...
            switch (expr.Kind)
            {
                ...
                case BoundKind.FieldAccess:
                    var access = (BoundFieldAccess)expr;
                    if (!access.FieldSymbol.IsStatic)
                    {
                        return CanBePassedByReference(access.ReceiverOpt);
                    }
